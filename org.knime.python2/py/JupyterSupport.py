...
# Most of the following code is copied/modified from:
...
def load_notebook(notebook_path, notebook_version=None):
    ...
    notebook_path, notebook_version = _standardize_input(notebook_path, notebook_version)
...
def _standardize_input(notebook_path, notebook_version):
    if notebook_path is None:
        raise ValueError("Notebook path must not be None.")
